...
def get_arguments():
    ...
    if not options.interface:
        parser.error("[-] Pleace specify interface, use --help for more info")
    elif not options.new_mac:
        parser.error("[-] Pleace specify new MAC, use --help for more info")
    return options
...
if current_mac == options.new_mac:
    print("[+] MAC address was succesfully change to " + current_mac)
else:
